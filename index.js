...
import { Component, Directive, ElementRef, EventEmitter, forwardRef, HostListener, Injectable, Input, NgModule, Output, Pipe, ViewChild } from '@angular/core';
...
var PhoneNumberComponent = /** @class */ (function () {
    ...
    PhoneNumberComponent.decorators = [
        { type: Component, args: [{
                    ...
                    template: require('./ngx-international-phone-number.html'),
